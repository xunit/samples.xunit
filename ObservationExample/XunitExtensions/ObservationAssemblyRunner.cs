...
namespace XunitExtensions
{
    ...
    {
        public ObservationAssemblyRunner(ITestAssembly testAssembly, IEnumerable<ObservationTestCase> testCases, IMessageSink messageSink, ITestFrameworkOptions executionOptions)
        ...
        protected override Task<RunSummary> RunTestCollectionAsync(IMessageBus messageBus, ITestCollection testCollection, IEnumerable<ObservationTestCase> testCases, CancellationTokenSource cancellationTokenSource)
        {
